...
using WpfHexaEditor;
using WPFHexEditorControl.Avalonia.Core;
using WPFHexEditorControl.Avalonia.Core.EventArguments;
using WPFHexEditorControl.Avalonia.Core.Interfaces;
...
namespace WpfHexEditorCore.Avalonia
{
    ...
    abstract class BaseByte : Control, IByteControl
    {
        ...
        private Brush _foregroundProperty;
        ...
        private static readonly StyledProperty<IBrush> ForegroundProperty =
            TextElement.ForegroundProperty.AddOwnerBaseByte));

        protected Brush Foreground
        {
            get => _foregroundProperty;
