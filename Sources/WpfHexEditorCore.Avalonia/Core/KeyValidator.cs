...
using WPFHexEditorControl.Avalonia.Core.Native;
...
namespace WPFHexEditorControl.Avalonia.Core
{
    ...
    public static class KeyValidator
    {
        ...
        public static bool IsCtrlCKey(Key key, KeyModifiers modifiers)
        {
            return key == Key.C && (modifiers & KeyModifiers.Control) == KeyModifiers.Control;
        }
        public static bool IsCtrlZKey(KeyModifiers modifiers)
        {
            return modifiers == KeyModifiers.Control;
        }

        public static bool IsCtrlYKey(Key key, KeyModifiers modifiers)
        {
            return key == Key.Y && (modifiers & KeyModifiers.Control) == KeyModifiers.Control;
        }
        public static bool IsCtrlVKey(Key key, KeyModifiers modifiers)
        {
            return key == Key.V && (modifiers & KeyModifiers.Control) == KeyModifiers.Control;
        }
        public static bool IsCtrlAKey(Key key, KeyModifiers modifiers)
        {
            return key == Key.A && (modifiers & KeyModifiers.Control) == KeyModifiers.Control;
        }
        ...
        public static char GetCharFromKey(Key key)
        {
            ...
            Key avaloniaKey = key; // Replace with your actual Avalonia Key

            int virtualKey = (int)KeyInterop.VirtualKeyFromKey(avaloniaKey);
